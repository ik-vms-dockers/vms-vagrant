...
export ZSH=/home/ivanka-lp/.oh-my-zsh
...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=('status' 'root_indicator' 'os_icon' 'todo' 'context' 'dir' 'vcs')
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=('disk_usage' 'aws' 'load' 'time' 'vi_mode')
